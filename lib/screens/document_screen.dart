...
import 'package:google_docs_clone_flutter/repository/socket_repository.dart';
      ...
      body: Center(
        child: Column(
          children: [
            ...
            quill.QuillToolbar.simple(configurations: QuillSimpleToolbarConfigurations(controller: _controller),),
            const SizedBox(height: 10),
            Expanded(
              child: SizedBox(
                width: 750,
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: quill.QuillEditor.basic(configurations: QuillEditorConfigurations(controller: _controller),),
                  ),
                ),
              ),
            )
